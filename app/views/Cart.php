...
?>
<div class="bg-white w-full mt-8 p-10 flex flex-col justify-center items-center gap-[50px]">
    <?php
    if (!count($data))
    ...
    ?>
        ...
        <div class="flex flex-col gap-4">
            ...
            <div class="flex justify-between items-center gap-5">
                Quantity:
                <span class="rounded-[50%]  h-[20px] text-center leading-[20px] w-[20px] border-[1px] border-gray-400 up-counter" data-id="<?php echo $product->id; ?>">+</span>
                <span class="counter">
                    <?php echo $product->qte; ?>
                </span>
                <span class="rounded-[50%] h-[20px] w-[20px] text-center leading-[20px] border-[1px] border-gray-400 down-counter" data-id="<?php echo $product->id; ?>">-</span>
            </div>
        ...
        <a href="/Order" class="p-4 bg-black text-white rounded-tl-[15px] rounded-br-[15px] font-semibold mx-auto my-0 block w-fit">valider votre commande</a>
    <?php
    }
    ?>
</div>
